...
export default function AboutTeaser() {
  return (
    <section className="bg-gradient-to-b from-pink-bg to-white py-24 px-6 md:px-12">
      <div className="max-w-[900px] mx-auto flex flex-col md:flex-row gap-14 items-center">
        {/* Visual */}
        <Reveal className="flex-shrink-0 w-full max-w-[280px] h-[340px] rounded-3xl bg-[linear-gradient(160deg,#5B2D6E,#8B3A6B,#C45A7C)] relative overflow-hidden">
        ...
        <Reveal delay={0.15} className="flex-1 text-center md:text-left">
          ...
          <h2 className="font-serif text-[clamp(28px,3vw,38px)] text-purple-dark font-normal leading-snug mb-5">
            Povestea din spatele misiunii mele
          </h2>
          <p className="text-[15px] text-[#6B5070] leading-relaxed mb-4 font-light">
          ...
          <p className="text-[15px] text-[#6B5070] leading-relaxed mb-6 font-light">
          ...
          <Link
            href="/despre"
            className="inline-flex items-center gap-2 text-sm text-purple-mid font-medium hover:gap-3 transition-all"
          >
            Citește povestea completă
            <svg className="w-4 h-4 fill-purple-mid" viewBox="0 0 24 24">
