    ...
    <div className="flex gap-4 justify-center">
      {[
        ...
        <div key={t.label} className="text-center">
          ...
          <p className="text-[12px] uppercase tracking-wider mt-1.5" style={{ color: "rgba(255,255,255,0.85)" }}>{t.label}</p>
        </div>
      ))}
    </div>
  );
...
function StickyCtaBar() {
  ...
  const buttons = (
    <div className="flex flex-row gap-2 sm:gap-3 justify-center items-center">
      <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" onClick={() => trackLead("WhatsApp")} className="inline-flex items-center gap-1.5 text-white px-4 sm:px-7 py-2.5 sm:py-3 rounded-full text-[12px] sm:text-[15px] font-medium hover:-translate-y-0.5 transition-all whitespace-nowrap" style={{ background: "linear-gradient(135deg, #25D366, #128C7E)", boxShadow: "0 6px 20px rgba(37,211,102,0.25)" }}>
        <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-white" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
        WhatsApp
      </a>
      <a href="#pricing" onClick={() => trackLead("Early Booking")} className="inline-flex items-center gap-1.5 text-white px-4 sm:px-7 py-2.5 sm:py-3 rounded-full text-[12px] sm:text-[15px] font-medium hover:-translate-y-0.5 transition-all whitespace-nowrap" style={{ background: "linear-gradient(135deg, #B8860B, #8B6914)", boxShadow: "0 6px 20px rgba(184,134,11,0.3)" }}>Early Booking</a>
    </div>
  );
    ...
    <>
      ...
      <section id="pricing" className="py-0 overflow-hidden">
        <div className="max-w-[800px] mx-auto rounded-2xl overflow-hidden" style={{ border: "1px solid #e0e0e0" }}>
          ...
          <div className="bg-white px-6 md:px-10 py-10">
            ...
            <Reveal delay={0.1}>
              <div className="rounded-2xl p-7 mb-8 bg-white relative" style={{ border: "3px solid #6C3483" }}>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-xl py-5 px-4 text-center" style={{ background: "linear-gradient(160deg, #F0E6F6, #E8DCF0)" }}>
                    <p className="text-[12px] uppercase tracking-wider font-medium mb-2" style={{ color: "#6C3483" }}>Loc in camera dubla</p>
                  ...
                  <div className="rounded-xl py-5 px-4 text-center" style={{ background: "linear-gradient(160deg, #F0E6F6, #E8DCF0)" }}>
                    <p className="text-[12px] uppercase tracking-wider font-medium mb-2" style={{ color: "#6C3483" }}>Camera single</p>
            ...
            {/* Standard pricing */}
            <Reveal delay={0.15}>
              <p className="text-[12px] uppercase tracking-[2px] font-medium mb-3 text-center" style={{ color: "#444" }}>Pret standard (dupa 16 iunie)</p>
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="rounded-xl p-5 text-center" style={{ border: "1.5px solid #ddd" }}>
                  <p className="text-[11px] uppercase tracking-wider mb-1" style={{ color: "#555" }}>Loc in camera dubla</p>
                  <p className="font-serif text-[30px] font-semibold" style={{ color: "#1a1a1a" }}>2.950 <span className="text-[14px] font-normal" style={{ color: "#555" }}>RON</span></p>
                </div>
                <div className="rounded-xl p-5 text-center" style={{ border: "1.5px solid #ddd" }}>
                  <p className="text-[11px] uppercase tracking-wider mb-1" style={{ color: "#555" }}>Camera single</p>
                  <p className="font-serif text-[30px] font-semibold" style={{ color: "#1a1a1a" }}>3.320 <span className="text-[14px] font-normal" style={{ color: "#555" }}>RON</span></p>
                </div>
              </div>
            </Reveal>
            ...
            <Reveal delay={0.3}>
              <div className="mt-10 rounded-2xl p-6 text-center" style={{ background: "linear-gradient(160deg, #1E3230 0%, #264540 30%, #306858 60%, #4A8870 100%)" }}>
                <p className="text-[12px] uppercase tracking-[3px] mb-5" style={{ color: "rgba(255,255,255,0.9)" }}>Timp ramas pentru Early Booking</p>
                <EarlyBirdCountdown />
              </div>
            </Reveal>
          </div>
      ...
      <section className="py-20 px-6 text-center" style={{ background: "linear-gradient(160deg, #264540 0%, #306858 40%, #4A8870 70%, #D4B060 100%)" }}>
        <Reveal>
          ...
          <a href={formUrl} target="_blank" rel="noopener noreferrer" className="inline-block text-white px-10 py-4 rounded-full text-[16px] font-medium hover:-translate-y-0.5 transition-all" style={{ background: "linear-gradient(135deg, #E870A0, #A855D0)", boxShadow: "0 6px 24px rgba(168,85,208,0.3)" }} onClick={() => trackLead("Vreau locul meu")}>Da! Vreau locul meu!</a>
        </Reveal>
      </section>
    </>
  );
