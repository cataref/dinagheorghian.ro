...
function StickyCtaBar() {
  ...
  const buttons = (
    <div className="flex flex-row gap-2 sm:gap-3 justify-center items-center">
      <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-white px-4 sm:px-7 py-2.5 sm:py-3 rounded-full text-[12px] sm:text-[15px] font-medium hover:-translate-y-0.5 transition-all whitespace-nowrap" style={{ background: "linear-gradient(135deg, #25D366, #128C7E)", boxShadow: "0 6px 20px rgba(37,211,102,0.25)" }}>
      ...
      <a href="#pricing" className="inline-flex items-center gap-1.5 text-white px-4 sm:px-7 py-2.5 sm:py-3 rounded-full text-[12px] sm:text-[15px] font-medium hover:-translate-y-0.5 transition-all whitespace-nowrap" style={{ background: "linear-gradient(135deg, #B8860B, #8B6914)", boxShadow: "0 6px 20px rgba(184,134,11,0.3)" }}>Early Booking</a>
    </div>
  );
